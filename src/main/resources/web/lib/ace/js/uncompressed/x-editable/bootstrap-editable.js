    ...
    */
    ...
    $.fn.editableform.defaults = {
        ...
        **/
        ...
        If function - it will be called instead of ajax. Function should return deferred object to process fail/done callbacks.
    ...
    Editable.prototype = {
        ...
        init: function () {
            ...
            switch(this.options.autotext) {
              ...
              break;
              case 'auto':
                //if element text is empty and value is defined and value not generated by text --> process autotext
            ...
            //depending on autotext process render() or just finilize init
        ...
        initLive: function() {
           ...
           this.$element.on(this.options.toggle + '.editable', selector, $.proxy(function(e){
               ...
               if(!$target.data('editable')) {
                   //if delegated element initially empty, we need to remove it's text (that was manually set to `empty` by user)
    ...
    $.extend(List.prototype, {
            ...
            if (typeof source === 'string') {
                ...
                $.ajax({
                    ...
                    success: $.proxy(function (data) {
                        ...
                        if($.isArray(this.sourceData)) {
                            if(cache) {
                                ...
                                //process success callbacks for other fields waiting for this source
                            ...
                            error.call(this);
                            if(cache) {
                                //process error callbacks for other fields waiting for this source
                    ...
                    error: $.proxy(function () {
                        ...
                        if(cache) {
                             cache.loading = false;
                             //process error callbacks for other fields
                             $.each(cache.err_callbacks, function () { this.call(); }); 
                        }
                    }, this)
                });
        ...
        doPrepend: function () {
            ...
            if(!$.isArray(this.prependData)) {
                //process prepend if it is function (once)
    ...
    $.extend(Text.prototype, {
        ...
        renderClear:  function() {
           if (this.options.clear) {
               this.$clear = $('<span class="editable-remove-x"></span>');
        ...
        postrender: function() {
            /*
            //now `remove` is positioned via css
            if(this.$remove) {
                //can position remove button only here, when form is shown and height can be calculated
//                var h = this.$input.outerHeight(true) || 20,
                var h = this.$remove.parent().height(),
                    delta = (h - this.$remove.height()) / 2;
                    
                //this.$remove.css({bottom: delta, right: delta});
            }
            */ 
        },
    ...
    $.extend(NumberInput.prototype, {
        ...
        postrender: function() {
            if(this.$clear) {
                ...
                this.$remove.css({top: delta, right: delta + 16});
                */
            } 
        }        
    });     
...
(function ($) {
    ...
    $.extend(Constructor.prototype, {
        render: function () {
            ...
            if(this.options.remove) {
                this.$remove = $('<a href="#"></a>').html(this.options.remove).click($.proxy(function(e){
                    e.preventDefault();
                    e.stopPropagation();
                    this.remove();
                }, this));
                
                this.$tpl.parent().append($('<div class="editable-remove">').append(this.$remove));
            } 
            */               
        },
    ...
    Constructor.defaults = $.extend({}, $.fn.editabletypes.abstractinput.defaults, {
        ...
        **/
        ...
        /*
        (not implemented yet)
        Text shown as remove date button.
        If <code>false</code> remove button will not be rendered.
...
(function( $ ) {
	...
	function opts_from_locale(lang){
		// Derive options from locale handler
		var out = {};
		// Check if "de-DE" style date is available, if not language should
		// fallback to 2 letter code eg "de"
		if (!dates[lang]) {
	...
	var DPGlobal = {
		...
		footTemplate: '<tfoot><tr><th colspan="7" class="today"></th></tr><tr><th colspan="7" class="remove"></th></tr></tfoot>'
	};
    ...
    $.extend(Date.prototype, {
        ...
        render: function () {
            ...
            if(this.options.clear) {
                ...
                this.$tpl.parent().append($('<div class="editable-remove">').append(this.$clear));
            }                
        },
