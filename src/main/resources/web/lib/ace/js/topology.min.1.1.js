(function (e) {
    ...
    function t(e, t, n, i, s, u) {
        ...
        if (!!a) {
            if (!f) {
                for (var T in a)if (a[C](T))if (ht[C](T) || t.paper.customAttributes[C](T)) {
                    ...
                    switch (ht[T]) {
                        ...
                        case"colour":
                            m[T] = w.getRGB(m[T]);
                            var N = w.getRGB(g[T]);
                            y[T] = {r: (N.r - m[T].r) / v, g: (N.g - m[T].g) / v, b: (N.b - m[T].b) / v};
                            break;
                        case"path":
                        ...
                        case"transform":
                            ...
                            if (_) {
                                ...
                                var P = t.matrix || new o, H = {_: {transform: M.transform}, getBBox: function () {
                                    return t.getBBox(1)
                                }};
                ...
                d = a.start || e.start || +(new Date), b = {anim: e, percent: n, timestamp: d, start: d + (e.del || 0), status: 0, initstatus: i || 0, stop: !1, ms: v, easing: R, from: m, diff: y, to: g, el: t, callback: a.callback, prev: p, next: h, repeat: u || e.times, origin: t.attr(), totalOrigin: s}, An.push(b);
                if (i && !f && !l) {
    ...
    function i() {
        return this.x + B + this.y + B + this.width + " 鑴� " + this.height
    }
    ...
    function a(e, t, n) {
        ...
        for (var v = 0; v < u + 1; v++) {
            ...
            f.push({x: m.x, y: m.y, t: v / u})
        }
        for (v = 0; v < a + 1; v++)m = w.findDotsAtSegment.apply(w, t.concat(v / a)), l.push({x: m.x, y: m.y, t: v / a});
        for (v = 0; v < u; v++)for (var g = 0; g < a; g++) {
            ...
            if (N) {
                ...
                C >= 0 && C <= 1 && k >= 0 && k <= 1 && (n ? d++ : d.push({x: N.x, y: N.y, t1: C, t2: k}))
            }
        }
        return d
    }
    ...
    function g(e, t, n) {
        function r() {
            var i = Array.prototype.slice.call(arguments, 0), s = i.join("閳碘偓"), o = r.cache = r.cache || {}, u = r.count = r.count || [];
            if (o[C](s)) {
                y(u, s);
                return n ? n(o[s]) : o[s]
            }
    ...
    var Dt = function (e) {
        if (w.vml) {
            ...
            o.title = "Rapha姣沴 Colour Picker", o.style.display = "none", k.doc.body.appendChild(o), Dt = g(function (e) {
                o.style.color = e;
        ...
        e *= 255, t *= 255, n *= 255;
        var i = {r: e, g: t, b: n, hex: w.rgb(e, t, n), toString: Bt};
        w.is(r, "finite") && (i.opacity = r);
        return i
    };
    w.color = function (e) {
        var t;
        w.is(e, "object") && "h"in e && "s"in e && "b"in e ? (t = w.hsb2rgb(e), e.r = t.r, e.g = t.g, e.b = t.b, e.hex = t.hex) : w.is(e, "object") && "h"in e && "s"in e && "l"in e ? (t = w.hsl2rgb(e), e.r = t.r, e.g = t.g, e.b = t.b, e.hex = t.hex) : (w.is(e, "string") && (e = w.getRGB(e)), w.is(e, "object") && "r"in e && "g"in e && "b"in e ? (t = w.rgb2hsl(e), e.h = t.h, e.s = t.s, e.l = t.l, t = w.rgb2hsb(e), e.v = t.b) : (e = {hex: "none"}, e.r = e.g = e.b = e.h = e.s = e.v = e.l = -1)), e.toString = Bt;
        return e
        ...
        return{h: r, s: i, b: s, toString: Pt}
        ...
        return{h: r, s: i, l: s, toString: Ht}
    ...
    w.getRGB = g(function (e) {
        if (!e || !!((e = j(e)).indexOf("-") + 1))return{r: -1, g: -1, b: -1, hex: "none", error: 1, toString: m};
        if (e == "none")return{r: -1, g: -1, b: -1, hex: "none", toString: m};
        ...
        if (a) {
            ...
            if (a[5]) {
                u = a[5][F](dt), n = at(u[0]), u[0].slice(-1) == "%" && (n *= 2.55), r = at(u[1]), u[1].slice(-1) == "%" && (r *= 2.55), i = at(u[2]), u[2].slice(-1) == "%" && (i *= 2.55), (u[0].slice(-3) == "deg" || u[0].slice(-1) == "鎺�") && (n /= 360), a[1].toLowerCase().slice(0, 4) == "hsba" && (s = at(u[3])), u[3] && u[3].slice(-1) == "%" && (s /= 100);
                return w.hsb2rgb(n, r, i, s)
            }
            if (a[6]) {
                u = a[6][F](dt), n = at(u[0]), u[0].slice(-1) == "%" && (n *= 2.55), r = at(u[1]), u[1].slice(-1) == "%" && (r *= 2.55), i = at(u[2]), u[2].slice(-1) == "%" && (i *= 2.55), (u[0].slice(-3) == "deg" || u[0].slice(-1) == "鎺�") && (n /= 360), a[1].toLowerCase().slice(0, 4) == "hsla" && (s = at(u[3])), u[3] && u[3].slice(-1) == "%" && (s /= 100);
                return w.hsl2rgb(n, r, i, s)
            }
            a = {r: n, g: r, b: i, toString: m}, a.hex = "#" + (16777216 | i | r << 8 | n << 16).toString(16).slice(1), w.is(s, "finite") && (a.opacity = s);
            return a
        }
        return{r: -1, g: -1, b: -1, hex: "none", error: 1, toString: m}
        ...
        t.h += .075, t.h > 1 && (t.h = 0, t.s -= .2, t.s <= 0 && (this.getColor.start = {h: 0, s: 1, b: t.b}));
        return n.hex
    ...
    var qt = function (e) {
        var t = qt.ps = qt.ps || {};
        t[e] ? t[e].sleep = 100 : t[e] = {sleep: 100}, setTimeout(function () {
    ...
    w.findDotsAtSegment = function (e, t, n, r, i, s, o, u, a) {
        ...
        (m > y || g < b) && (T += 180);
        return{x: d, y: v, m: {x: m, y: g}, n: {x: y, y: b}, start: {x: w, y: E}, end: {x: S, y: x}, alpha: T}
        ...
        return function () {
            eve("raphael.log", null, "Rapha姣沴: you are calling to method 閳ワ拷" + e + "閳ワ拷 of removed object", e)
        }
    };
    var Rt = w.pathBBox = function (e) {
        ...
        var l = W[_](0, i), c = W[_](0, s), h = z[_](0, i), p = z[_](0, s), d = {x: l, y: c, x2: h, y2: p, width: h - l, height: p - c};
        t.bbox = b(d);
        return d
    }, Ut = function (e) {
        var t = b(e);
        ...
        var f = 1 - a;
        return{x: V(f, 3) * e + V(f, 2) * 3 * a * n + f * 3 * a * a * i + V(a, 3) * o, y: V(f, 3) * t + V(f, 2) * 3 * a * r + f * 3 * a * a * s + V(a, 3) * u}
        ...
        return{min: {x: W[_](0, d), y: W[_](0, p)}, max: {x: z[_](0, d), y: z[_](0, p)}}
    }), Qt = w._path2curve = g(function (e, t) {
        var n = !t && qt(e);
        if (!t && n.curve)return Ut(n.curve);
        var r = Wt(e), i = t && Wt(t), s = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, o = {x: 0, y: 0, bx: 0, by: 0, X: 0, Y: 0, qx: null, qy: null}, u = function (e, t) {
            var n, r;
        ...
        var n = Rt(e), r = {_: {transform: H}, getBBox: function () {
            return n
        }};
        on(r, t);
        return r.matrix
    ...
    w._getContainer = function (e, t, n, r) {
        ...
        if (i != null)return i.tagName ? t == null ? {container: i, width: i.style.pixelWidth || i.offsetWidth, height: i.style.pixelHeight || i.offsetHeight} : {container: i, width: t, height: n} : {container: 1, x: e, y: t, width: n, height: r}
    ...
    for (var bn = I.length; bn--;)(function (e) {
        w[e] = yn[e] = function (t, n) {
            w.is(t, "function") && (this.events = this.events || [], this.events.push({name: e, f: t, unbind: dn(this.shape || this.node || k.doc, e, t, n || this)}));
            return this
    ...
    yn.drag = function (e, t, n, r, i, s) {
        function o(o) {
            ...
            this._drag.x = o.clientX + a, this._drag.y = o.clientY + u, this._drag.id = o.identifier, !vn.length && w.mousemove(mn).mouseup(gn), vn.push({el: this, move_scope: r, start_scope: i, end_scope: s}), t && eve.on("raphael.drag.start." + this.id, t), e && eve.on("raphael.drag.move." + this.id, e), n && eve.on("raphael.drag.end." + this.id, n), eve("raphael.drag.start." + this.id, i || r || this, o.clientX + a, o.clientY + u, o)
        }

        this._drag = {}, wn.push({el: this, start: o}), this.mousedown(o);
        return this
    ...
    O.getElementByPoint = function (e, t) {
        ...
        e = e || {};
        var t = {width: (e.width || 10) + (+this.attr("stroke-width") || 1), fill: e.fill || !1, opacity: e.opacity || .5, offsetx: e.offsetx || 0, offsety: e.offsety || 0, color: e.color || "#000"}, n = t.width / 2, r = this.paper, i = r.set(), s = this.realPath || Lt[this.type](this);
    ...
    var Sn = {}, xn = function (e, t, n, r, i, s, o, u, a) {
        ...
        return function (n, r, i) {
                ...
                if (u[0] == "M")s = +u[1], o = +u[2]; else {
                    ...
                    if (h + a > r) {
                        ...
                        if (!e && !t) {
                            ...
                            return{x: c.x, y: c.y, alpha: c.alpha}
                        }
                    }
                    h += a, s = +u[5], o = +u[6]
                }
            ...
            l.end = f, c = e ? h : t ? l : w.findDotsAtSegment(s, o, u[0], u[1], u[2], u[3], u[4], u[5], 1), c.alpha && (c = {x: c.x, y: c.y, alpha: c.alpha});
            return c
        }
    ...
    var Ln = w.easing_formulas = {linear: function (e) {
        return e
    }, "<": function (e) {
        return V(e, 1.7)
    }, ">": function (e) {
    ...
    yn.animateWith = function (e, r, i, s, o, u) {
        ...
        for (; i < s; i++) {
            ...
            if (o.el.id == this.id && (!e || o.anim == e)) {
                ...
                r.push({anim: o.anim, status: o.status})
            }
        }
        return e ? 0 : r
    }, yn.pause = function (e) {
    ...
    Pn.attr = function (e, t) {
        ...
        r = r || "normal", n = n || "normal", t = +t || {normal: 400, bold: 700, lighter: 300, bolder: 800}[t] || 400;
        if (!!w.fonts) {
            var i = w.fonts[e];
            if (!i) {
    ...
    e.toString = function () {
        return"Your browser supports SVG.\nYou are running Rapha姣沴 " + this.version
    };
    var m = function (r, i) {
        if (i) {
        ...
        m(d, {fill: "url(#" + l + ")", opacity: 1, "fill-opacity": 1}), g.fill = c, g.opacity = 1, g.fillOpacity = 1;
        return 1
    }, y = function (e) {
        var t = e.getBBox(1);
    ...
    N.prototype = C, C.constructor = N, e._engine.path = function (e, t) {
        ...
        var r = new N(n, t);
        r.type = "path", S(r, {fill: "none", stroke: "#000", path: e});
        return r
        ...
        i = i == null ? o.x + o.width / 2 : i, s = s == null ? o.y + o.height / 2 : s, this.transform(this._.transform.concat([
            ["s", e, t, i, s]
        ]));
        return this
    }, C.translate = function (e, t) {
        if (this.removed)return this;
        e = n(e).split(f), e.length - 1 && (t = r(e[1])), e = r(e[0]) || 0, t = +t || 0, this.transform(this._.transform.concat([
            ["t", e, t]
        ]));
        return this
        ...
        var s = new N(i, e);
        s.attrs = {cx: t, cy: n, r: r, fill: "none", stroke: "#000"}, s.type = "circle", m(i, s.attrs);
        return s
    }, e._engine.rect = function (e, t, n, r, i, s) {
        var o = m("rect");
        e.canvas && e.canvas.appendChild(o);
        var u = new N(o, e);
        u.attrs = {x: t, y: n, width: r, height: i, r: s || 0, rx: s || 0, ry: s || 0, fill: "none", stroke: "#000"}, u.type = "rect", m(o, u.attrs);
        return u
    }, e._engine.ellipse = function (e, t, n, r, i) {
        var s = m("ellipse");
        e.canvas && e.canvas.appendChild(s);
        var o = new N(s, e);
        o.attrs = {cx: t, cy: n, rx: r, ry: i, fill: "none", stroke: "#000"}, o.type = "ellipse", m(s, o.attrs);
        return o
        ...
        var u = new N(o, e);
        u.attrs = {x: n, y: r, width: i, height: s, src: t}, u.type = "image";
        return u
    }, e._engine.text = function (t, n, r, i) {
        var s = m("text");
        t.canvas && t.canvas.appendChild(s);
        var o = new N(s, t);
        o.attrs = {x: n, y: r, "text-anchor": "middle", text: i, font: e._availableAttrs.font, stroke: "none", fill: "#000"}, o.type = "text", S(o, o.attrs);
        return o
        ...
        this.bottom = this.top = null, (this.desc = m("desc")).appendChild(e._g.doc.createTextNode("Created with Rapha姣沴 " + e.version)), t.appendChild(this.desc), t.appendChild(this.defs = m("defs"))
    ...
    e.toString = function () {
        return"Your browser doesn閳ユ獩 support SVG. Falling down to VML.\nYou are running Rapha姣沴 " + this.version
    };
    var C = function (e, t, r) {
        ...
        if (a.opacity != null || a["stroke-width"] != null || a.fill != null || a.src != null || a.stroke != null || a["stroke-width"] != null || a["stroke-opacity"] != null || a["fill-opacity"] != null || a["stroke-dasharray"] != null || a["stroke-miterlimit"] != null || a["stroke-linejoin"] != null || a["stroke-linecap"] != null) {
            ...
            if (I.on && a.fill) {
                ...
                } else I.color = e.getRGB(a.fill).hex, I.src = d, I.type = "solid", e.getRGB(a.fill).error && (b.type in{circle: 1, ellipse: 1} || n(a.fill).charAt() != "r") && L(b, a.fill, I) && (h.fill = "none", h.gradient = a.fill, I.rotate = !1)
            }
            ...
            if (a["stroke-dasharray"]) {
                var K = {"-": "shortdash", ".": "shortdot", "-.": "shortdashdot", "-..": "shortdashdotdot", ". ": "dot", "- ": "dash", "--": "longdash", "- .": "dashdot", "--.": "longdashdot", "--..": "longdashdotdot"};
    ...
    A.prototype = O, O.constructor = A, O.transform = function (t) {
        ...
        if (this.removed)return this;
        e = n(e).split(l), e.length - 1 && (t = r(e[1])), e = r(e[0]) || 0, t = +t || 0, this._.bbox && (this._.bbox.x += e, this._.bbox.y += t), this.transform(this._.transform.concat([
            ["t", e, t]
        ]));
        return this
        ...
        s.X = t - r, s.Y = n - i, s.W = r * 2, s.H = i * 2, s.type = "ellipse", k(s, {cx: t, cy: n, rx: r, ry: i});
        return s
    }, e._engine.circle = function (e, t, n, r) {
        var i = e.path(), s = i.attrs;
        i.X = t - r, i.Y = n - r, i.W = i.H = r * 2, i.type = "circle", k(i, {cx: t, cy: n, r: r});
        return i
        ...
        s && (l = a / i, c = u / r, r * l < u && (t -= (u - r * l) / 2 / l), i * c < a && (n -= (a - i * c) / 2 / c)), this._viewBox = [t, n, r, i, !!s], this._viewBoxShift = {dx: -t, dy: -n, scale: f}, this.forEach(function (e) {
            e.transform("...")
        });
        return this
    };
...
Venus.util = {};
Venus.config = {version: 1, debug: !1};
(function () {
    function n(e, t) {
        var n = Object.prototype.toString.call(e).slice(8, -1);
        n = n.toLowerCase();
        return t ? e !== undefined && e !== null && n === t : n
    }

    var e = Venus.util || {}, t = function (e, t, n) {
        var r, i, s, o, u = [];
        r = Math.floor(e / 60) % 6;
        i = r % 2 ? e / 60 - r : 1 - (e / 60 - r);
        s = n * (1 - t);
        o = n * (1 - i * t);
        switch (r) {
            case 0:
        ...
        for (var a = 0, f = u.length; a < f; a++)u[a] = Math.floor(u[a] * 255);
        return u
    };
    e.getColors = function (e) {
        var n = [.6, .2, .05, .1333, .75, 0], r = [.75, .75, .45, 1, .35], i = [.75, .45, .9, .6, .9], s = [], o;
        e = parseInt(e, 10) || 10;
        o = Math.min(e, Math.max(e / r.length, 12));
        for (var u = 0; u < e; u++)u < n.length && e <= n.length ? s.push("rgba(" + t(n[u] * 360, r[0], i[0]).join(",") + ", 1)") : s.push("rgba(" + t(u % o * 360 / o, r[Math.floor(u / o)], i[Math.floor(u / o)]).join(",") + ", 1)");
        return s
    };
    e.mix = function (t, n) {
        for (var r in n)typeof n[r] != "object" || t[r] === undefined || typeof t[r] != "object" ? t[r] = n[r] : e.mix(t[r], n[r]);
        return t
    };
    ...
    e.clone = function (t) {
        if (typeof t == "string" || typeof t == "boolean" || typeof t == "number" || t == null || e.isFunction(t))return t;
        if (e.isArray(t))return t.slice(0);
        if (e.isObject(t)) {
            var n = {};
            for (var r in t)n[r] = e.clone(t[r]);
            return n
        }
    };
    e.number = {add: function () {
        var e = Array.prototype.slice.call(arguments, 0), t = 1, n = 0;
        e.forEach(function (e) {
            e.toString().indexOf(".") != -1 && (t = Math.pow(10, e.toString().split(".")[1].length))
        });
        e.forEach(function (e) {
            n += e * t
        });
        ...
        var e = Array.prototype.slice.call(arguments, 0), t = 1, n = 1, r = 1;
        e.forEach(function (e) {
    ...
    e.date = {parse: function (t) {
        try {
            if (typeof t == "string" && t.indexOf(" ") !== -1 && t.indexOf(":") == -1 && t.indexOf(" ") !== t.length - 1)t += ":00"; else if (e.isNumber(t))return new Date(t);
            var n = Date.parse(t);
            if (!n && n !== 0)throw"can't convert date " + t;
            return new Date(n)
        } catch (r) {
            throw"can't convert date " + t
        }
    }, format: function (e, t) {
        e = this.parse(e);
        var n = t || "yyyy-MM-dd hh:mm::ss", r = e.getFullYear().toString(), i = "0" + (e.getMonth() + 1), s = "0" + e.getDate(), o = "0" + e.getHours(), u = "0" + e.getMinutes(), a = "0" + e.getSeconds(), f = n.replace("yyyy", r).replace("yy", r.substr(r.length - 2)).replace("MM", i.substr(i.length - 2)).replace("dd", s.substr(s.length - 2)).replace("hh", o.substr(o.length - 2)).replace("mm", u.substr(u.length - 2)).replace("ss", a.substr(a.length - 2));
        return f
    }}
})();
(function () {
    var e = Venus.util || {}, t = Array.prototype.slice, n = function () {
        this.events = {}
    }, r = function (e, t) {
        return e.events[t] || (e.events[t] = {callbacks: []})
    }, i = function (e, t, n) {
        r(e, t).callbacks.push(n)
    };
    ...
    n.prototype.off = function (e, t) {
        if (!t)this.events[e] = {callbacks: []}; else {
            var n, i = 0, s = r(this, e).callbacks;
            while (n = s[i++])n === t && s.splice(--i, 1)
        }
    };
    n.prototype.one = function (e, n) {
        if (typeof n != "function")return;
        var r = this;
        i(this, e, function () {
            n.apply(e, t.call(arguments, 0));
            r.off(e, arguments.callee)
        })
    };
    n.prototype.fire = function () {
        var e = arguments[0], n = t.call(arguments, 1), r, i = 0;
        if (this.events[e] && this.events[e].callbacks)while (r = this.events[e].callbacks[i++])r.apply(e, n);
        return this
    };
...
(function () {
    ...
    t.prototype = {addParent: function (e) {
        !this._exist(this.parents, e) && this.parents.push(e) && (this._parentsHash[e.id] = e)
    }, addParentEdge: function (e) {
        this.parentsEdges.push(e)
    }, addChild: function (e) {
        !this._exist(this.children, e) && this.children.push(e) && (this._childrenHash[e.id] = e)
    }, addChildEdge: function (e) {
        this.childrenEdges.push(e)
    }, hasChild: function (e) {
        return!!this._childrenHash[e.id]
    }, hasParent: function (e) {
        return!!this._parentsHash[e.id]
    }, setIndex: function (e) {
        this.indexInLayer = e
    }, setGraph: function (e) {
        this.graph = e
    }, setTextElement: function (e) {
        this.textElement = e
    }, getIndex: function () {
        ...
        return n
    }, render: function (e, n, r, i, s) {
        this.type = n;
        this.view = t.types[n].create.call(this, e, r, i, s);
        this.view.data("node", this)
    }, position: function (e, n) {
        return t.types[this.type].position.call(this, e, n)
    }, highlight: function (e) {
        var t = {stroke: "#FF6600", "stroke-width": 2};
        if (!this.isHighlight) {
            this.isHighlight = !0;
            this.viewCache = {stroke: this.view.attr("stroke"), "stroke-width": this.view.attr("stroke-width")};
            this.view.attr(t);
            return!0
        }
    ...
    t.extend("circle", {create: function (e, t, n, r) {
        return e.circle(t, n, r)
    }, position: function (e, t) {
        if (e === undefined && t === undefined)return{x: this.view.attr("cx"), y: this.view.attr("cy")};
        this.view.attr({cx: e, cy: t})
    }});
    t.extend("rect", {create: function (e, t, n, r) {
        return e.rect(t - r, n - r, r * 2, r * 2)
    }, position: function (e, t) {
        if (e === undefined && t === undefined)return{x: this.view.attr("x") + this.view.attr("width") / 2, y: this.view.attr("y") + this.view.attr("height") / 2};
        this.view.attr({x: e - this.view.attr("width") / 2, y: t - this.view.attr("height") / 2})
    }});
    Venus.Topology.Node = t;
    t.index = 0
})();
(function (e) {
    e.initController = function (e, t, n, r, i, s, o) {
        function W() {
            if (document.webkitIsFullScreen || document.mozFullScreen) {
                t.setSize(window.screen.width, window.screen.height);
                y.transform("T" + (window.screen.width - z - 20) + "," + 10)
            } else {
                t.setSize(n, r);
                y.transform("T" + (n - z - 20) + "," + 10)
            }
        }

        var u = 1, a = 1, f = s || 0, l = o || 0, c = function (t) {
            if (t) {
                u *= 1.25;
                a *= 1.25
            } else {
            ...
            e.transform("S" + u + "," + a + "," + n / 2 + "," + r / 2 + "T" + f + "," + l)
        }, h = function (t, i) {
            f += t;
            l += i;
            e.transform("S" + u + "," + a + "," + n / 2 + "," + r / 2 + "T" + f + "," + l)
        }, p, d, v = "http://maps.gstatic.cn/intl/zh-CN_cn/mapfiles/openhand_8_8.cur", m = "http://maps.gstatic.cn/intl/zh-CN_cn/mapfiles/closedhand_8_8.cur";
        t.canvas.style.cursor = 'url("' + v + '"), move';
        this.container.style.boxShadow = "0 0 1px 1px #ccc inset";
        var g = navigator.userAgent.indexOf("Firefox") == -1 ? "mousewheel" : "DOMMouseScroll";
        t.canvas.addEventListener(g, function (e) {
            e.preventDefault();
            c(e.wheelDelta !== undefined ? e.wheelDelta > 0 : e.detail < 0)
        }, !1);
        (new Raphael.el.constructor(t.canvas, t)).drag(function (e, t, n, r, i) {
            h(e - p, t - d);
            p = e;
            d = t
        }, function () {
            t.canvas.style.cursor = 'url("' + m + '"),move';
            p = 0;
            d = 0
        }, function () {
            t.canvas.style.cursor = 'url("' + v + '"),move'
        });
        var y = t.g(), b, w, E, S, x, T = 31, N = 31, C = 30, k = 5, L = 10, A = 6, O = L - A;
        b = t.circle(T, N, C).attr({stroke: "#ccc", "stroke-width": 1, fill: "#fff", cursor: "default"});
        y.node.appendChild(b.node);
        E = t.path().attr({path: ["M", T, k, "l", -L, L, "h", A, "l", O, -O, "l", O, O, "h", A, "l", -L, -L, "z"], fill: "#999999", stroke: "none", cursor: "pointer"});
        y.node.appendChild(E.node);
        w = E.clone().transform("r-90," + T + "," + k + "t" + (k - C) + "," + (k - C)).click(function (e) {
            e.stopPropagation();
            h(n / 10, 0)
        });
        y.node.appendChild(w.node);
        S = E.clone().transform("r90," + T + "," + k + "t" + (C - k) + "," + (k - C)).click(function (e) {
            e.stopPropagation();
            h(-n / 10, 0)
        });
        y.node.appendChild(S.node);
        x = E.clone().transform("r180," + T + "," + k + "t" + 0 + "," + 2 * (k - C)).click(function (e) {
            e.stopPropagation();
            h(0, -r / 10)
        });
        ...
        var M, _, D, P, H, B, j, F, I = this.container, q = 10, R = 5, U = 20;
        M = t.rect(2 * (C + 1) + q, R, U, U).attr({stroke: "#000", "stroke-width": 1, "stroke-opacity": .5, cursor: "pointer", fill: "#fff"});
        _ = M.clone().attr({y: 2 * (C + 1) - 1 - U - R});
        D = t.text(2 * (C + 1) + q + U / 2, R + 1 + U / 2, "+").attr({"font-size": 16, cursor: "pointer"});
        P = t.text(2 * (C + 1) + q + U / 2, 2 * (C + 1) - 1 - R - 1 - U / 2, "-").attr({"font-size": 16, cursor: "pointer"});
        y.node.appendChild(M.node);
        y.node.appendChild(_.node);
        y.node.appendChild(D.node);
        y.node.appendChild(P.node);
        M.click(function (e) {
            e.stopPropagation();
            c(!0)
        });
        ...
        H = M.clone().attr("x", 2 * (C + 1) + q * 2 + 2 + U);
        y.node.appendChild(H.node);
        H.click(function (e) {
            var n = t.canvas;
        ...
        B = E.clone().transform("t" + (C + 1 + q * 2 + U * 2) + "," + 2 + "r" + 45 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(B.node);
        B = E.clone().transform("t" + (C + 1 + q * 2 + U + 4) + "," + 2 + "r" + -45 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(B.node);
        B = E.clone().transform("t" + (C + 1 + q * 2 + U * 2) + "," + (U - 2) + "r" + 135 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(B.node);
        B = E.clone().transform("t" + (C + 1 + q * 2 + U + 4) + "," + (U - 2) + "r" + -135 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(B.node);
        j = _.clone().attr("x", 2 * (C + 1) + q * 2 + 2 + U);
        y.node.appendChild(j.node);
        j.click(function (e) {
            e.stopPropagation();
        ...
        F = E.clone().transform("t" + (C + 1 + q * 2 + U * 1.5 + 4) + "," + (2 * (C + 1) - U) + "r" + -45 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(F.node);
        F = E.clone().transform("t" + (C + 1 + q * 2 + U * 1.5) + "," + (2 * C - U) + "r" + 135 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(F.node);
        F = E.clone().transform("t" + (C + 1 + q * 2 + U * 1.5 + 4) + "," + (2 * C - U) + "r" + -135 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(F.node);
        F = E.clone().transform("t" + (C + 1 + q * 2 + U * 1.5) + "," + (2 * (C + 1) - U) + "r" + 45 + "," + T + "," + k + "s.5,.5," + T + "," + k);
        y.node.appendChild(F.node);
        var z = 2 * (C + 1) + q * 2 + 4 + U * 2;
        t.canvas.addEventListener("webkitfullscreenchange", W, !1);
        document.addEventListener("mozfullscreenchange", W, !1);
        y.transform("T" + (n - z - 20) + "," + 10)
    }
})(Venus);
(function () {
    Raphael._engine.g = function (e) {
        var t = "http://www.w3.org/2000/svg", n = document.createElementNS(t, "g");
        e.canvas && e.canvas.appendChild(n);
        var r = new Raphael.el.constructor(n, e);
        r.type = "g";
        n.setAttributeNS(t, "fill", "#fff");
        return r
    };
    Raphael.fn.g = function () {
        var e = Raphael._engine.g(this);
        this.__set__ && this.__set__.push(e);
        return e
    };
    var e = "straightline", t = "polyline", n = "parent_on_top", r = "parent_on_bottom", i = "parent_to_child", s = "child_to_parent", o = Venus.Topology, u = function (t, s, o) {
        if (!t || !t.nodeType)return;
        this.container = t;
        this.data = s || [];
        var u = this.options = Venus.util.mix({width: t.clientWidth, height: t.clientHeight, layerDirection: n, arrowDirection: i, padding: 40, layerHeight: null, nodeRadius: 30, nodeType: "circle", arrowLength: 10, arrowWidth: 1, colorMap: {1: "#FF0000", 2: "#7CFC00", 3: "#B1C9ED"}, edgeColor: {normal: "#999", error: "red", focus: "#FF6600"}, badStatus: [], align: "middle", defaultView: "", singleMax: 4, edgeType: e, enableController: !0, useAsText: "text", enableDrag: !0, keepLayerWhenDrag: !1, click: function (e, t) {
        }, mouseover: function (e, t) {
        }, mouseout: function (e, t) {
        }, contextmenu: function (e, t) {
        }, drag: function (e, t) {
        }, showCrossLayerEdge: !1, reduceCrossing: !0}, Venus.util.clone(o || {})), a = this.stage = new Raphael(t, u.width, u.height), f = this;
        this._prepareNodes();
        this._layNodes();
        u.layerDirection == r && this.graphs.forEach(function (e) {
            e.resultLayers.reverse()
        });
        this.graphs.sort(function (e, t) {
            return t.resultLayers.length - e.resultLayers.length
        });
        u.reduceCrossing && this._reduceCrossing();
        Object.keys(this.nodes).forEach(function (e) {
            var t = f.nodes[e];
            t.parents.sort(function (e, t) {
                return e.indexInLayer - t.indexInLayer
            })
        });
        this._renderNodes();
        this._renderEdges();
        u.showCrossLayerEdge && this._renderCrossLayerEdges();
        u.badStatus.length && this._focusBad();
        u.enableDrag && this._enableDrag();
        u.enableController && Venus.initController.call(this, f.group, a, u.width, u.height, u, f.transformX, f.transformY)
    };
    u.prototype = {_prepareNodes: function () {
        function i(i, s) {
            var u = i.id;
            s && s.length && s.forEach(function (s) {
                var a = n[s];
                a || r.data.forEach(function (t) {
                    if (t.id == s) {
                        a = new o.Node(t);
                        n[s] = a;
                        e[s] = a
        ...
        function s(i, s) {
            ...
            s.forEach(function (s) {
                var u = n[s];
                u || r.data.forEach(function (e) {
                    if (e.id == s) {
                        u = new Venus.Topology.Node(e);
                        n[s] = u;
                        t[s] = u
                    }
                });
        ...
        var e, t = [], n = {}, r = [], i = function (e, t, n) {
            ...
            if (!Venus.util.isArray(e) || !e.length)return;
            var u = [], a = [];
            e.forEach(function (e) {
                var o = e._layer;
                e.children && e.children.length && e.children.forEach(function (o) {
                    s(o, e._layer + 1, t, n) && a.push(o);
                    if (i(n[e._layer], e, o))return;
                    var u = {from: e, to: o};
                    if (t[e._layer + 1].indexOf(o) != -1) {
                        u.node1 = e;
                        u.node2 = o;
                        n[e._layer].push(u)
                    } else if (t[e._layer - 1] && t[e._layer - 1].indexOf(o) != -1) {
                        u.node1 = o;
                        u.node2 = e;
                        n[e._layer - 1].push(u)
                    } else r.push(u)
                });
                e.parents && e.parents.length && e.parents.forEach(function (a) {
                    s(a, o - 1, t, n) && u.push(a);
                    if (i(n[o - 1], a, e))return;
                    var f = {from: a, to: e};
                    if (t[o - 1].indexOf(a) != -1) {
                        f.node1 = a;
                        f.node2 = e;
                        n[o - 1].push(f)
                    } else if (t[o + 1] && t[o + 1].indexOf(a) != -1) {
                        f.node1 = e;
                        f.node2 = a;
                        n[o].push(f)
                    } else r.push(f)
        ...
        e = this.noParentNodes;
        Object.keys(e).forEach(function (r) {
            var i = e[r];
            if (n[r])return;
            var u = {}, a = [], f = {}, l = [], c = {layers: u, resultLayers: a, start: i, edgeGroups: l}, h = 0;
            t.push(c);
            s(i, h, u, f) && o([i], u, f);
            Object.keys(u).sort(function (e, t) {
                ...
                a.push(u[e]);
                u[e].forEach(function (e, t) {
                    e.setIndex(t);
                    e.setGraph(c)
                })
            });
            Object.keys(f).sort(function (e, t) {
                return e - t
            }).filter(function (e) {
                return!!f[e].length
            }).forEach(function (e) {
        ...
        this.graphs = t;
        this.crossLayerEdges = r
    }, _reduceCrossing: function () {
        var e = this;
        this.graphs.forEach(function (e, t) {
            if (t !== 0)return;
            var n = e.edgeGroups, r = e.resultLayers;
            n.forEach(function (e, t) {
                var n = {}, i = [], s = 0;
                e.forEach(function (e) {
                    var t = e.node2.id;
                    n[t] || (n[t] = {value: 0, count: 0}) && i.push(e.node2);
                    n[t].value += e.node1.getIndex();
                    n[t].count++
                });
                i.sort(function (e, t) {
                    var r = e.id, i = t.id;
                    return n[r].value / n[r].count - n[i].value / n[i].count
                });
                r[t + 1].map(function (e, t) {
                    return n[e.id] ? i[s++] : e
                });
                r[t + 1].forEach(function (e, t) {
                    e.setIndex(t)
                })
            });
            for (var i = n.length - 1; i >= 0; i--) {
                ...
                u.forEach(function (e) {
                    var t = e.node1.id;
                    s[t] || (s[t] = {value: 0, count: 0}) && o.push(e.node1);
                    s[t].value += e.node2.getIndex();
                    s[t].count++
                });
                o.sort(function (e, t) {
                    var n = e.id, r = t.id;
                    return s[n].value / s[n].count - s[r].value / s[r].count
                });
                r[i].map(function (e, t) {
                    return s[e.id] ? o[a++] : e
                });
                r[i].forEach(function (e, t) {
                    e.setIndex(t)
                })
            }
        })
        ...
        function p(t, n, i) {
            t.render(r, e.nodeType, n, i, e.nodeRadius);
            var o = t.view.attr({fill: e.colorMap[t.info.status], stroke: "none", "stroke-width": 1, cursor: "pointer"}).click(function (n) {
                if (this._isDragging) {
                    this._isDragging = !1;
                    return
                }
                e.click.call(this, n, t)
            }).mouseover(function (n) {
                if (this._isDragging) {
                    this._isDragging = !1;
                    return
                }
                e.mouseover.call(this, n, t)
            }).mouseout(function (n) {
                if (this._isDragging) {
                    this._isDragging = !1;
                    return
                }
                e.mouseout.call(this, n, t)
            });
            e.contextmenu && o.node.addEventListener("contextmenu", function (n) {
                e.contextmenu.call(o, n, t)
            });
            s.node.appendChild(o.node);
            return o
        }

        var e = this.options, t = e.width, n = e.height, r = this.stage, i = this, s = r.g(), o = e.padding, u = 0, a = 0, f = null, l, c, h;
        this.group = s;
        this.graphs.forEach(function (d, v) {
            var m = r.set(), g = r.set(), y = {}, b = r.set(), w = d.resultLayers, E, S = e.singleMax;
            E = Math.max.apply(Math, w.map(function (e) {
                return e.length
            })) || 1;
            if (v == 0) {
                E == 2 && (E = 3);
                c = e.layerHeight || (w.length > 1 ? (n - e.padding * 2) / (w.length - 1) : n - e.padding * 2);
                l = E > 1 ? (t - e.padding * 2) / (E - 1) : 0;
                if (e.enableController) {
                    l < 4 * e.nodeRadius && (l = 4 * e.nodeRadius);
                    c < 4 * e.nodeRadius && (c = 4 * e.nodeRadius)
                }
                h = l;
                i.layerHeight = c;
                w.forEach(function (n, i) {
                    var o = e.align == "left" ? e.nodeRadius : (t - (n.length - 1) * l) / 2;
                    n.forEach(function (t, n) {
                        var u = o + n * l, a = e.padding + c * i;
                        f === null ? f = u : f = Math.min(f, u);
                        var h = e.colorMap[t.info.status] || "green", d = Raphael.getRGB(h), v = Raphael.rgb2hsl(d.r, d.g, d.b), y, b;
                        y = p(t, u, a);
                        m.push(y);
                        b = r.text(u, a, e.useAsText === undefined ? t.id : t.info[e.useAsText]);
                        t.setTextElement(b);
                        s.node.appendChild(b.node);
                        g.push(b)
                    })
                })
            } else if (w.length > 1)w.forEach(function (t, n) {
                var i = e.align == "left" ? -e.nodeRadius - h : -(E + t.length / 2 - 1) * l - h, u = o;
                e.align !== "left" && e.defaultView === "all" && (i += f);
                t.forEach(function (t, n) {
                    var o = i + n * l, f = u;
                    a = Math.min(a, o);
                    var c = e.colorMap[t.info.status] || "green", h = Raphael.getRGB(c), d = Raphael.rgb2hsl(h.r, h.g, h.b), v, y;
                    v = p(t, o, f);
                    m.push(v);
                    y = r.text(o, f, e.useAsText === undefined ? t.id : t.info[e.useAsText]);
                    t.setTextElement(y);
                    s.node.appendChild(y.node);
                    g.push(y)
                });
                o += c
            }); else if (w[0] && w[0][0]) {
                var x = w[0][0], T = -e.nodeRadius - u % S * l - h, N = c * Math.floor(u / S) + o;
                e.align !== "left" && e.defaultView === "all" && (T += f);
                a = Math.min(a, T);
                var C = p(x, T, N);
                m.push(C);
                var k = r.text(T, N, e.useAsText === undefined ? x.id : x.info[e.useAsText]);
                x.setTextElement(k);
                s.node.appendChild(k.node);
                g.push(k);
                u++
            }
            d.relation = y;
        ...
        if (e.defaultView == "all") {
            i.transformX = -a + e.nodeRadius;
            i.transformY = i.transformY || 0;
            i.group.transform("T" + i.transformX + "," + i.transformY)
        }
    }, _renderEdges: function () {
        var e = this.group, t = this.options, n = this.stage, r = this;
        this.graphs.forEach(function (i, s) {
            i.edgeGroups.forEach(function (s, o) {
                s.forEach(function (s) {
                    r.arrow(n, s, (r.layerHeight - 2 * t.nodeRadius - t.arrowLength * 2) / i.resultLayers[o].length);
                    e.node.appendChild(s.line.node);
                    e.node.appendChild(s.arrow.node);
                    s.from.addChildEdge(s);
                    s.to.addParentEdge(s)
                })
            })
        })
    }, _renderCrossLayerEdges: function () {
        var e = this, t = e.stage, n = e.group;
        this.crossLayerEdges.forEach(function (r) {
            e.arrow(t, r);
            n.node.appendChild(r.line.node);
            n.node.appendChild(r.arrow.node);
            r.from.addChildEdge(r);
            r.to.addParentEdge(r)
        })
    }, _focusBad: function () {
        var e = this;
        for (var t = 0, n = this.graphs.length; t < n; t++)for (var r = 0, i = this.graphs[t].resultLayers.length; r < i; r++)for (var s = 0, o = this.graphs[t].resultLayers[r].length; s < o; s++) {
            var u = this.graphs[t].resultLayers[r][s];
            if (e.options.badStatus.indexOf(u.info.status) !== -1) {
                e.transformY = -u.position().y + e.options.nodeRadius;
                e.group.transform("T" + (e.transformX || 0) + "," + e.transformY);
                return
            }
        }
    }, straightPath: function (e, t, n, r) {
        var i = this.options, s = i.nodeRadius, o = i.arrowLength, u = Math.sqrt(Math.pow(r - t, 2) + Math.pow(n - e, 2)) - 2 * s, a, f = ["M", e + s, t, "h", u], l = ["M", e + s + u, t, "l", -o, -o / 2, "l", o / 2, o / 2, -o / 2, o / 2, o, -o / 2], c = e, h = t;
        t == r ? e > n ? a = Math.PI : a = 0 : a = Math.acos((n - e) / (u + 2 * s)) * (t > r ? 1 : -1);
        if (i.nodeType == "rect") {
            u = Math.sqrt(Math.pow(Math.abs(t - r) - 2 * s, 2) + Math.pow(n - e, 2));
            a = Math.acos((n - e) / u) * (t > r ? 1 : -1);
            f = ["M", e, t > r ? t - s : t + s, "h", u];
            l = ["M", e + u, t > r ? t - s : t + s, "l", -o, -o / 2, "l", o / 2, o / 2, -o / 2, o / 2, o, -o / 2];
            c = e;
            h = t > r ? t - s : t + s;
            if (t == r) {
                u = Math.abs(e - n) - 2 * s;
                f = ["M", e + s, t, "h", u];
                l = ["M", e + s + u, t, "l", -o, -o / 2, "l", o / 2, o / 2, -o / 2, o / 2, o, -o / 2];
                h = t;
                e > n ? a = Math.PI : a = 0
            }
        }
        return{path: f, arrowPath: l, alpha: 360 - a * 180 / Math.PI, x: c, y: h}
    }, arrow: function (e, n, r) {
        var i = n.from.position(), s = n.to.position(), o = parseInt(i.x), u = parseInt(i.y), a = parseInt(s.x), f = parseInt(s.y), l = this.options, c = l.edgeColor.normal, h = l.edgeColor.error, p;
        if (l.edgeType == t && u < f) {
            var d, v, m;
            n.to.parents.forEach(function (e, t) {
                if (parseInt(e.position().x) == a) {
                    v = t;
                    d = !0
                }
            });
            o === a ? m = 0 : d ? m = l.arrowLength * (n.to.parents.indexOf(n.from) - v) : m = l.arrowLength * (n.to.parents.indexOf(n.from) - Math.floor(n.to.parents.length / 2));
            p = this.polyLinePath(o, u, a, f, m, (n.from.indexInLayer + 1) * r)
        } else p = this.straightPath(o, u, a, f);
        n.arrow = (n.arrow || e.path()).attr({path: p.arrowPath, fill: c, stroke: "none"});
        n.line = (n.line || e.path()).attr({path: p.path, "stroke-width": l.arrowWidth, stroke: c});
        n.line.transform("R" + p.alpha + "," + p.x + "," + p.y);
        n.arrow.transform("R" + p.alpha + "," + p.x + "," + p.y);
        if (u > f) {
            n.arrow.attr("fill", h);
            n.line.attr("stroke", h)
        }
    }, polyLinePath: function (e, t, n, r, i, s) {
        var o = this.options, u = o.nodeRadius, a = o.arrowLength, f, l;
        if (t < r)if (e == n) {
            l = ["M", e, t + u, "V", r - u, "M", n, r - u, "l", -a / 2, -a, "l", a / 2, a / 2, "l", a / 2, -a / 2, "l", -a / 2, a];
            f = ["M", n, r - u, "l", -a / 2, -a, "l", a / 2, a / 2, "l", a / 2, -a / 2, "l", -a / 2, a]
        } else {
            l = ["M", e, t + u, "v", s, "H", n + i, "V", r - u];
            f = ["M", n + i, r - u, "l", -a / 2, -a, "l", a / 2, a / 2, "l", a / 2, -a / 2, "l", -a / 2, a]
        } else if (e == n) {
            l = ["M", e, t - u, "V", r + u];
            f = ["M", n, r + u, "l", -a / 2, a, "l", a / 2, -a / 2, "l", a / 2, a / 2, "l", -a / 2, -a]
        } else {
        ...
        return{path: l, arrowPath: f, alpha: 0}
    }, _enableDrag: function () {
        var e = this;
        e.graphs.forEach(function (t) {
            t.nodeElements.forEach(function (n, r) {
                var i, s;
                n.drag(function (o, u, a, f, l) {
                    l.stopPropagation();
                    var c, h;
                    this._isDragging = !0;
                    c = o + i;
                    h = u + s;
                    if (e.options.keepLayerWhenDrag) {
                        this.attr({cx: c});
                        h = s
                    } else this.attr({cx: c, cy: h});
                    this.data("node").position(c, h);
                    t.textElements[r].attr({x: c, y: h});
                    var p = n.data("node");
                    p.parentsEdges.forEach(function (t) {
                        e.arrow(e.stage, t)
                    });
                    p.childrenEdges.forEach(function (t) {
                        e.arrow(e.stage, t)
                    });
                    e.options.drag.call(n, l, p)
                }, function (e, t, n) {
                    n.stopPropagation();
                    i = this.data("node").position().x;
                    s = this.data("node").position().y
                }, function (e) {
                    e.stopPropagation()
                })
            })
        })
    }, highlightParents: function (e) {
        function r(e) {
            if (t.indexOf(e) !== -1)return!1;
            t.push(e);
            e.highlight(n.focus);
            e.parentsEdges.forEach(function (e) {
                e.viewCache = {arrow: {fill: e.arrow.attr("fill")}, line: {stroke: e.line.attr("stroke"), "stroke-width": e.line.attr("stroke-width")}};
                e.arrow.attr("fill", n.focus);
                e.line.attr("stroke", n.focus);
                e.line.attr("stroke-width", 2)
            });
        ...
        var t = [], n = this.options.edgeColor;
        r(e)
    }, cancelHighlightParents: function (e) {
        function n(e) {
            if (t.indexOf(e) !== -1)return!1;
            t.push(e);
            e.cancelHighlight();
            e.parentsEdges.forEach(function (e) {
                if (e.viewCache) {
                    e.arrow.attr(e.viewCache.arrow);
                    e.line.attr(e.viewCache.line)
                }
            });
            e.parents.forEach(function (e) {
                n(e)
        ...
        var t = [];
        n(e)
    }, highlightChildren: function (e) {
        function r(e) {
            if (t.indexOf(e) !== -1)return!1;
            t.push(e);
            e.highlight(n.focus);
            e.childrenEdges.forEach(function (e) {
                e.viewCache = {arrow: {fill: e.arrow.attr("fill")}, line: {stroke: e.line.attr("stroke"), "stroke-width": e.line.attr("stroke-width")}};
                e.arrow.attr("fill", n.focus);
                e.line.attr("stroke", n.focus);
                e.line.attr("stroke-width", 2)
        ...
        var t = [], n = this.options.edgeColor;
        r(e)
    }, cancelHighlightChildren: function (e) {
        function n(e) {
            if (t.indexOf(e) !== -1)return!1;
            t.push(e);
            e.cancelHighlight();
        ...
        var t = this;
        t.graphs.forEach(function (n) {
            n.resultLayers.forEach(function (n) {
        ...
        this.group.node.appendChild(e.node)
        ...
        this.group.transform(e)
    }, setNodePosition: function (e, t, n) {
        e.position(t, n);
        e.textElement.attr({x: t, y: n});
        var r = this;
        e.parentsEdges.forEach(function (e) {
            r.arrow(r.stage, e)
        });
    ...
    Venus.util.mix(u, Venus.Topology);
    Venus.Topology = u
})();
if (typeof _gaq == "undefined") {
    ...
    }, pageTracker = {_trackPageview: vga}, ga = document.createElement("script");
